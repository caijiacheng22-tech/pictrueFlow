...
private:
    ...
    bool loadGames();
    bool createDefaultGamesConfig(const QString& path) const;
    QPixmap loadCoverPixmap(const GameInfo& game) const;
    void showConfigMessage(const QString& title, const QString& message);
